...
def mock_hid():
    ...
    class MockConsumerControl:
        def send(self, code):
            print(f"Simulant l'envoi du code de contrôle: {code}")

    class MockMouse:
        def click(self, button):
            print(f"Simulant le clic de la souris: {button}")
    ...
    sys.modules['adafruit_hid'] = type('module', (object,), {
        'ConsumerControl': MockConsumerControl,
